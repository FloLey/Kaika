...
export const ARG_HELP: Record<string, Record<string, string>> = {
  ...
  lyrics: {
    ...
    position: "Vertical placement of the text WITHIN the box: top, center or bottom.",
    ...
    box_x: "Left edge of the text box, as a fraction of the frame width.",
    box_y: "Top edge of the text box, as a fraction of the frame height.",
    box_w: "Text box width (fraction of the frame). Text wraps and shrinks to fit inside it.",
    box_h: "Text box height (fraction of the frame). Text shrinks to fit inside it.",
    ...
    size: "Text height as a fraction of the frame (the starting size before auto-fit).",
    r: "Red channel of the text colour.",
    g: "Green channel of the text colour.",
    b: "Blue channel of the text colour.",
