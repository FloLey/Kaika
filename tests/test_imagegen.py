"""The imagegen slideshow card: trigger-driven image switching, block-seam
continuity, and hash coverage of the asset list."""
...
from backend.graph_render import _imagegen_index
...
def test_asset_list_changes_bust_the_output_hash(assets):
    def graph_for(urls):
        return {"version": 1, "nodes": [
            {"id": "ig", "type": "imagegen", "data": {"assetUrls": urls, "ports": {}}},
            {"id": "o", "type": "output", "data": {}},
