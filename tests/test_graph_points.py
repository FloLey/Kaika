...
def _fluid(nid="f"):
    ports = {k: {"binding": {"kind": "const", "value": v}} for k, v in
             [("force", 0), ("emit", 0.5), ("radius", 0.05), ("r", 1), ("g", 1), ("b", 1)]}
    return {"id": nid, "type": "fluid", "x": 0, "y": 0, "data": {
        "static": {"enabled": True, "radial": False, "wrap": True, "points": [[0.5, 0.5]],
                   "path_speed": 1, "path_closed": False, "path_pingpong": False,
                   "intensity": 1.0, "opacity": 1.0, "color": [1, 1, 1]},
        "ports": ports}}
...
def test_points_fluid_into_merge_contributes_n_emitters():
    ...
    cb = {"id": "cb", "type": "combine", "x": 0, "y": 0,
          "data": {"mode": "merge", "inputs": [{"id": "s0"}], "medium": {}}}
    out = {"id": "o", "type": "output", "x": 0, "y": 0, "data": {}}
    g = {"version": 1, "nodes": [f, pts, cb, out], "edges": [
        _edge("p", "f", "positions"), _edge("f", "cb", "s0"), _edge("cb", "o", "video")]}
